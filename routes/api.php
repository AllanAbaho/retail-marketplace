...
Route::group(['prefix' => 'v2', 'middleware' => ['app_language']], function() {
    ...
    Route::get('jobs', 'App\Http\Controllers\Api\V2\JobsController@index');
    Route::post('jobs', 'App\Http\Controllers\Api\V2\JobsController@store');
    Route::get('jobs/{id}', 'App\Http\Controllers\Api\V2\JobsController@getSingleJob');
    Route::post('posted-jobs', 'App\Http\Controllers\Api\V2\JobsController@postedJobs');
    Route::post('applied-jobs', 'App\Http\Controllers\Api\V2\JobsController@appliedJobs');
    Route::post('post-job-application', 'App\Http\Controllers\Api\V2\JobApplicationController@store');
    Route::post('approve-job-application', 'App\Http\Controllers\Api\V2\JobApplicationController@updateJobApplication');
    Route::post('change-job-status', 'App\Http\Controllers\Api\V2\JobsController@changeJobStatus');
    ...
    Route::post('add-shop', [ShopController::class, 'store'])->name('shop.store');
    ...
    Route::post('order/paySeller', 'App\Http\Controllers\Api\V2\OrderController@paySeller');
